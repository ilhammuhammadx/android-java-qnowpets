...
public class KucingActivity extends AppCompatActivity {
    ...
    String[] NamaSub = {
            "Definisi seputar kucing",
            "Berbagai macam jenis kucing",
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent;
                if(position == 0)
                    intent = new Intent(view.getContext(), ApaKucingActivity.class);
                else
                    intent = new Intent(view.getContext(), JenisKucingActivity.class);
